  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-20 w-full' id='home' >
      ...
      <div className='py-2 md:py-12 flex-1 flex items-center relative'>
        ...
        <div className='h-370 lg:h-650 absolute flex top-4  md:top-[100px] lg:top-16 left-0 items-center justify-center py-2 gap-4 flex-wrap lg:px-0 xlL:px-9 2xl:px-[11rem]' >
