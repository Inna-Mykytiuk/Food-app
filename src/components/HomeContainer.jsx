      ...
      <div className="w-full md:min-h-screen h-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-2 p-6 px-10 mt-17 md:mt-20 md:px-16 lg:px-20 py-4 ">
        <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
          ...
          <p className="text-base text-mainTextGrey text-center md:text-left md:w-[80%]">
            Experience the fastest delivery in your city with City, where great
            food meets unparalleled convenience. Your satisfaction is our utmost
            priority, and we look forward to serving you with our passion for
