...
const CreateContainer = () => {
  ...
  return (
    <div
      className="w-full min-h-screen h-auto flex items-center justify-center mt-17 p-6 px-10 md:mt-[30px] md:px-16 lg:px-20 py-4"
      style={{
        width: '100%',
    ...
    >
      ...
      <div className="flex flex-col w-full h-full items-center justify-between px-4 md:px-0 max-w-6xl mx-auto">
        <div
          className="w-[90%] md:w-[75%]  rounded-lg p-4 flex flex-col items-center justify-center gap-4"
          style={{
            color: 'white',
        ...
        >
                  ...
                  <>
                    <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                      <div className="w-full h-full flex flex-col items-center justify-center cursor-pointer gap-2 ">
                        ...
                        <p className="text-gray-500 hover:text-headerBgColor">
                  ...
                  <>
                    <div className="relative h-full">
                      <img
                        src={imageAsset}
                        alt="uploadedImage"
                        className="w-full h-full objest-cover"
                      />
                      <button
                        type="button"
          ...
          <div className="flex items-center w-full">
            <button
              type="button"
              className="ml-0 md:ml-auto w-full md:w-auto border-none  px-12 py-2 taxt-lg text-white font-semibold shadow-md
